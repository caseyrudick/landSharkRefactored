...
// const Surveys = ({currentWell, currentWellId, saveWellPlansToJSONDb}) => {
...
// export default connect(mapStateToProps, {/*saveNewPlanToReduxStore,*/saveWellPlansToJSONDb})(Surveys)
